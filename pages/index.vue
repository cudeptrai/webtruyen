<template>
  <div class="container mx-auto max-w-5xl">
    <div class="mt-5">
      ...
      <div class="mt-3 ">
        <SlideProducts :data="ListProduct" />
      </div>
    ...
    <div class="text-center">
      <button class="p-3 bg-primary rounded-md font-semibold my-6 hover:bg-orange-600"><NuxtLink to="/">Xem thêm nhiều truyện</NuxtLink></button>
    </div>
  </div>
</template>
...
const ListProduct = [
  {
    name: 'Ta Là Tà Đế',
    chapter: '168',
    image: 'images/dau-pha-thuong-khung_1552264817.jpg',
    date: '1 ngày trước',
    isHot: true,
  },
  {
